...
extension NaverMapContainerView {
  ...
  func setCameraZoomLevel(_ point:Double) {
    naverMapView.mapView.moveCamera(NMFCameraUpdate(zoomTo:point))
  }
...
struct MapAccumulationCalculator {
  ...
  static func distanceToZoomLevel(distance: Int) -> Int {
    switch(distance) {
      case 0  ..< 2             : return 20
      case 2  ..< 5             : return 19
      case 5  ..< 10            : return 18
